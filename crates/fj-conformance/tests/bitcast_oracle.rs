...
fn oracle_bitcast_f64_to_i64_zero() {
    ...
    let result = eval_primitive(Primitive::BitcastConvertType, &[input], &bitcast_params("i64")).unwrap();
...
fn oracle_bitcast_i64_to_f64_zero() {
    ...
    let result = eval_primitive(Primitive::BitcastConvertType, &[input], &bitcast_params("f64")).unwrap();
...
fn oracle_bitcast_f64_i64_roundtrip() {
    ...
    let as_i64 = eval_primitive(Primitive::BitcastConvertType, &[input], &bitcast_params("i64")).unwrap();
    let back = eval_primitive(Primitive::BitcastConvertType, &[as_i64], &bitcast_params("f64")).unwrap();
...
fn oracle_bitcast_f32_to_u32_zero() {
    ...
    let result = eval_primitive(Primitive::BitcastConvertType, &[input], &bitcast_params("u32")).unwrap();
...
fn oracle_bitcast_u32_to_f32_roundtrip() {
    ...
    let as_u32 = eval_primitive(Primitive::BitcastConvertType, &[input], &bitcast_params("u32")).unwrap();
    let back = eval_primitive(Primitive::BitcastConvertType, &[as_u32], &bitcast_params("f32")).unwrap();
