...
fn category_specs() -> Vec<CategorySpec> {
    vec![
        ...
        CategorySpec {
            ...
            required_fuzz_families: &["ff_dispatch_request_builder", "ff_ledger_deserializer"],
...
fn fuzz_specs() -> Vec<FuzzSpec> {
    vec![
        ...
        FuzzSpec {
            family_id: "ff_egraph_rewrite_rules",
            target: "egraph_rewrite_rules",
            target_source: "crates/fj-conformance/fuzz/fuzz_targets/egraph_rewrite_rules.rs",
            corpus_path: "crates/fj-conformance/fuzz/corpus/seed/egraph_rewrite_rules",
            corpus_suffix: "seed/egraph_rewrite_rules",
            seed_floor: 1,
            expected_error_class: "typed_egraph_rewrite_result",
            hash_paths: &[
                "crates/fj-conformance/fuzz/corpus/seed/egraph_rewrite_rules/basic_chain",
            ],
        },
        FuzzSpec {
            family_id: "ff_ad_gradient_computation",
            target: "ad_gradient_computation",
            target_source: "crates/fj-conformance/fuzz/fuzz_targets/ad_gradient_computation.rs",
            corpus_path: "crates/fj-conformance/fuzz/corpus/seed/ad_gradient_computation",
            corpus_suffix: "seed/ad_gradient_computation",
            seed_floor: 1,
            expected_error_class: "typed_ad_gradient_result",
            hash_paths: &[
                "crates/fj-conformance/fuzz/corpus/seed/ad_gradient_computation/basic_gradient",
            ],
        },
        FuzzSpec {
            family_id: "ff_primitive_params_fuzzer",
            target: "primitive_params_fuzzer",
            target_source: "crates/fj-conformance/fuzz/fuzz_targets/primitive_params_fuzzer.rs",
            corpus_path: "crates/fj-conformance/fuzz/corpus/primitive_params_fuzzer",
            corpus_suffix: "primitive_params_fuzzer",
            seed_floor: 3,
            expected_error_class: "typed_primitive_params_result",
            hash_paths: &[
                "crates/fj-conformance/fuzz/corpus/primitive_params_fuzzer/seed_reduce",
                "crates/fj-conformance/fuzz/corpus/primitive_params_fuzzer/seed_slice",
            ],
        },
        FuzzSpec {
            family_id: "ff_proc_status_parser",
            target: "proc_status_parser",
            target_source: "crates/fj-conformance/fuzz/fuzz_targets/proc_status_parser.rs",
            corpus_path: "crates/fj-conformance/fuzz/corpus/seed/proc_status_parser",
            corpus_suffix: "seed/proc_status_parser",
            seed_floor: 3,
            expected_error_class: "typed_proc_status_parse_result",
            hash_paths: &["crates/fj-conformance/fuzz/corpus/seed/proc_status_parser/linux_status"],
        },
        FuzzSpec {
            family_id: "ff_jaxpr_serde_roundtrip",
            target: "jaxpr_serde_roundtrip",
            target_source: "crates/fj-conformance/fuzz/fuzz_targets/jaxpr_serde_roundtrip.rs",
            corpus_path: "crates/fj-conformance/fuzz/corpus/seed/jaxpr_serde_roundtrip",
            corpus_suffix: "seed/jaxpr_serde_roundtrip",
            seed_floor: 2,
            expected_error_class: "typed_jaxpr_serde_roundtrip_result",
            hash_paths: &[
                "crates/fj-conformance/fuzz/corpus/seed/jaxpr_serde_roundtrip/valid_add.json",
            ],
        },
        FuzzSpec {
            family_id: "ff_fft_roundtrip",
            target: "fft_roundtrip",
            target_source: "crates/fj-conformance/fuzz/fuzz_targets/fft_roundtrip.rs",
            corpus_path: "crates/fj-conformance/fuzz/corpus/seed/fft_roundtrip",
            corpus_suffix: "seed/fft_roundtrip",
            seed_floor: 1,
            expected_error_class: "typed_fft_roundtrip_result",
            hash_paths: &["crates/fj-conformance/fuzz/corpus/seed/fft_roundtrip/basic_signal"],
        },
        FuzzSpec {
        ...
        FuzzSpec {
            family_id: "ff_ledger_deserializer",
            target: "ledger_deserializer",
            target_source: "crates/fj-conformance/fuzz/fuzz_targets/ledger_deserializer.rs",
            corpus_path: "crates/fj-conformance/fuzz/corpus/seed/ledger_deserializer",
            corpus_suffix: "seed/ledger_deserializer",
            seed_floor: 3,
            expected_error_class: "typed_ledger_deserialize_result",
            hash_paths: &[
                "crates/fj-conformance/fuzz/corpus/seed/ledger_deserializer/valid_ledger_with_signals.json",
            ],
        },
    ]
}
...
fn row_specs() -> Vec<RowSpec> {
    vec![
        ...
        RowSpec {
            ...
            fuzz_family_id: "ff_ledger_deserializer",
            evidence_refs: &[
                "artifacts/e2e/e2e_p2c004_evidence_ledger_audit_trail.e2e.json",
                "artifacts/e2e/e2e_p2c004_strict_hardened_divergence.e2e.json",
                "crates/fj-conformance/fuzz/corpus/seed/ledger_deserializer/valid_ledger_with_signals.json",
            ],
            replay_command: "cd crates/fj-conformance/fuzz && cargo fuzz run ledger_deserializer corpus/seed/ledger_deserializer -runs=3",
        },
    ]
}
