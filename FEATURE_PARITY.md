...
Audit timestamp: **2026-05-01**, primitive-scope reconciliation refreshed **2026-05-12** (`cargo test --workspace` passed via `rch`; live inventory: 15 workspace crates, 157 canonical primitive variants, 152 V1 local eval/AD primitives, 5 pmap collectives that fail closed without multi-device context, 11 dtypes, 162,733 Rust source lines under `crates/`, 4,416 static Rust test/proptest markers, 115 conformance test files, and 861 committed JAX oracle fixture cases).
