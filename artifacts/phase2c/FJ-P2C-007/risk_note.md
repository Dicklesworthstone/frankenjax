# FJ-P2C-007 Risk Note

Subsystem: FFI call interface
...
- Risk ID: `risk.p2c007.ffi-boundary`
- Category: `security`
- Description: FFI remains the highest-risk boundary and requires adversarial contract gates for every new exported call.
- Likelihood: medium
- Impact: high
...
- Packet anchor maps and contract tables remain committed under `artifacts/phase2c/FJ-P2C-007/`.
