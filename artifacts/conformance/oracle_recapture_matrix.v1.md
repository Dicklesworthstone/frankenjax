...
| `linalg_fft` | 33/33 | `0.9.2` | `true` | `pass` | `python3 crates/fj-conformance/scripts/capture_linalg_fft_oracle.py --legacy-root legacy_jax_code/jax --output crates/fj-conformance/fixtures/linalg_fft_oracle.v1.json` |
| `composition` | 15/15 | `0.9.1` | `true` | `fail` | `python3 crates/fj-conformance/scripts/capture_composition_oracle.py --output crates/fj-conformance/fixtures/composition_oracle.v1.json` |
| `dtype_promotion` | 162/162 | `0.9.1` | `true` | `fail` | `python3 crates/fj-conformance/scripts/capture_dtype_promotion_oracle.py --output crates/fj-conformance/fixtures/dtype_promotion_oracle.v1.json` |
