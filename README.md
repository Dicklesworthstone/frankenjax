...
<div align="center">
  ...
  **Clean-room Rust reimplementation of JAX's transform semantics.**
  ...
  ![Tests](https://img.shields.io/badge/tests-2737_passing-brightgreen)
...
| 2,737 `#[test]` cases + proptest suites | All passing |
...
- **2,737 `#[test]` cases** plus proptest/property-based suites
