...
<div align="center">
  ...
  **Clean-room Rust reimplementation of JAX's transform semantics.**
  ...
  ![Tests](https://img.shields.io/badge/tests-3373_passing-brightgreen)
...
| 3,373 `#[test]` cases + proptest suites | All passing |
...
- **3,373 `#[test]` cases** plus proptest/property-based suites
