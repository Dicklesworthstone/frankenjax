...
<div align="center">
  ...
  **Clean-room Rust reimplementation of JAX's transform semantics.**
  ...
  ![Tests](https://img.shields.io/badge/tests-2766_passing-brightgreen)
...
| 2,766 `#[test]` cases + proptest suites | All passing |
...
- **2,766 `#[test]` cases** plus proptest/property-based suites
