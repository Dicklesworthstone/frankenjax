...
<div align="center">
  ...
  **Clean-room Rust reimplementation of JAX's transform semantics.**
  ...
  ![Tests](https://img.shields.io/badge/tests-2920_passing-brightgreen)
...
| 2,920 `#[test]` cases + proptest suites | All passing |
...
**131,647 lines of Rust** across 15 crates with end-to-end trace -> dispatch -> runtime pipeline:
...
- **2,920 `#[test]` cases** plus proptest/property-based suites
