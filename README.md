...
<div align="center">
  ...
  **Clean-room Rust reimplementation of JAX's transform semantics.**
  ...
  ![Tests](https://img.shields.io/badge/tests-2731_passing-brightgreen)
...
| 2,731 `#[test]` cases + proptest suites | All passing |
...
- **2,731 `#[test]` cases** plus proptest/property-based suites
