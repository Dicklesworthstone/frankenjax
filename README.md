...
<div align="center">
  ...
  **Clean-room Rust reimplementation of JAX's transform semantics.**
  ...
  ![Tests](https://img.shields.io/badge/tests-1806_passing-brightgreen)
...
| 1,806 `#[test]` cases + proptest suites | All passing |
...
- **1,806 `#[test]` cases** plus proptest/property-based suites
